...
- type: textarea
  ...
  placeholder: | 1. Define a schema with... 2. Use useForm with... 3. Observe that...
  validations:
  required: true
- type: textarea
  id: expected
...
- type: checkmarks
  ...
  attributes:
  label: Checklist
  options: - label: I have searched existing issues to ensure this bug hasn't been reported.
  required: true - label: I am using the latest version of SuperForm.
  required: true
